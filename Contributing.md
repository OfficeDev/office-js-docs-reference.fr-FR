...
* Documentation des bogues par le biais des problèmes de référentiels.
...
2. Une fois que vous disposez d’un compte, installez Git sur votre ordinateur. Suivez les étapes dans le didacticiel [configurer Git] .
...
Signature le CLA ne vous octroie les droits de validation dans le référentiel principal, mais cela signifie que les équipes de développement Office et Office pour les développeurs publication de contenu seront en mesure d’examiner et approuver votre contribution. Vous sont crédités pour vos envois.
...
2.  Installez Git sur votre ordinateur. Suivez les étapes dans le didacticiel [configurer Git] .
3.  Créez votre propre bifurcation du référentiel. Pour ce faire, dans la partie supérieure de la page, cliquez sur le bouton de la **branche** .
...
Tous les articles de ce référentiel utilisent Markdown. Vous trouverez une introduction complète (et annonce de la syntaxe de toutes les) à [Daring boule de feu - promotions].
...
* Pour en savoir plus sur les promotions, accédez au site du créateur promotions [Boule de feu Daring].
* Pour plus d’informations sur l’utilisation Git et référentiels, vérifiez d’abord à l' [Aide de référentiels].
