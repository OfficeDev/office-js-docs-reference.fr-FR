# <a name="customtab-element"></a><span data-ttu-id="2d0b1-101">Élément CustomTab</span><span class="sxs-lookup"><span data-stu-id="2d0b1-101">CustomTab element</span></span>
