# <a name="permissions-element"></a><span data-ttu-id="a536c-101">Élément Permissions</span><span class="sxs-lookup"><span data-stu-id="a536c-101">Permissions element</span></span>
