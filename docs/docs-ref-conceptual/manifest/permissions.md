# <a name="permissions-element"></a><span data-ttu-id="b798c-101">Élément Permissions</span><span class="sxs-lookup"><span data-stu-id="b798c-101">Permissions element</span></span>
