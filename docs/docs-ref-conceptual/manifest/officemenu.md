# <a name="officemenu-element"></a><span data-ttu-id="6fe8f-101">Élément OfficeMenu</span><span class="sxs-lookup"><span data-stu-id="6fe8f-101">OfficeMenu element</span></span>
