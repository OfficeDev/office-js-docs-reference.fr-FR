# <a name="desktopsettings-element"></a><span data-ttu-id="bc0fc-101">DesktopSettings, élément</span><span class="sxs-lookup"><span data-stu-id="bc0fc-101">DesktopSettings element</span></span>
