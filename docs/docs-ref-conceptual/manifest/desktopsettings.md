# <a name="desktopsettings-element"></a><span data-ttu-id="682c6-101">DesktopSettings, élément</span><span class="sxs-lookup"><span data-stu-id="682c6-101">DesktopSettings element</span></span>
