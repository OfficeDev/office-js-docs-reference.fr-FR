# <a name="mobileformfactor-element"></a><span data-ttu-id="73bac-101">Élément MobileFormFactor</span><span class="sxs-lookup"><span data-stu-id="73bac-101">MobileFormFactor element</span></span>
