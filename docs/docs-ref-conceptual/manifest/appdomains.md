# <a name="appdomains-element"></a><span data-ttu-id="9d4e4-101">Élément AppDomains</span><span class="sxs-lookup"><span data-stu-id="9d4e4-101">AppDomains element</span></span>
