# <a name="webapplicationinfo-element"></a><span data-ttu-id="bbd86-101">Élément WebApplicationInfo</span><span class="sxs-lookup"><span data-stu-id="bbd86-101">WebApplicationInfo element</span></span>
