...
> [!NOTE] 
> Actuellement, il est nécessaire que les ressources de votre complément correspond à son hôte. Office ne demandera pas un jeton pour un complément à moins de pouvoir prouver qu’il en est le propriétaire ; à l’heure actuelle, ceci s’effectue en hébergeant le complément sous le nom de domaine complet de la ressource.
