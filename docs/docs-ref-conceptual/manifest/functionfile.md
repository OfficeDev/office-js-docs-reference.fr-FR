# <a name="functionfile-element"></a><span data-ttu-id="beac7-101">Élément FunctionFile</span><span class="sxs-lookup"><span data-stu-id="beac7-101">FunctionFile element</span></span>
