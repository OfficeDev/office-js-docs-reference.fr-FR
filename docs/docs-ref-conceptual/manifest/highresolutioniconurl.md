# <a name="highresolutioniconurl-element"></a><span data-ttu-id="1c2eb-101">HighResolutionIconUrl, élément</span><span class="sxs-lookup"><span data-stu-id="1c2eb-101">HighResolutionIconUrl element</span></span>
