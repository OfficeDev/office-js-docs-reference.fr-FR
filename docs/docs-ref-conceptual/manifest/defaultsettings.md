# <a name="defaultsettings-element"></a><span data-ttu-id="39fb9-101">Élément DefaultSettings</span><span class="sxs-lookup"><span data-stu-id="39fb9-101">DefaultSettings element</span></span>
