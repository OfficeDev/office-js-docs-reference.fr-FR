...
Type : [LocalClientTime](/javascript/api/outlook_1_3/office.LocalClientTime)
...
|Nom| Type| Description|
|---|---|---|
|`input`| [LocalClientTime](/javascript/api/outlook_1_3/office.LocalClientTime)|Valeur de l’heure locale à convertir.|
