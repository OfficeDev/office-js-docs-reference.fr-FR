# <a name="office-javascript-api-reference"></a><span data-ttu-id="32d5b-101">Référence d’API JavaScript Office</span><span class="sxs-lookup"><span data-stu-id="32d5b-101">Office JavaScript API reference</span></span>
