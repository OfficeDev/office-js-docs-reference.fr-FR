...
||[suspendScreenUpdatingUntilNextSync()](/javascript/api/excel/excel.application#suspendscreenupdatinguntilnextsync--)|Interrompt la mise à jour de l’écran jusqu’à l’appel de la `context.sync()` méthode suivante.|
...
||[enabled](/javascript/api/excel/excel.autofilter#enabled)|Indique si le filtre automatique est activé.|
||[isDataFiltered](/javascript/api/excel/excel.autofilter#isdatafiltered)|Indique si le filtre automatique a des critères de filtre.|
...
|[ChartAreaFormat](/javascript/api/excel/excel.chartareaformat)|[colorScheme](/javascript/api/excel/excel.chartareaformat#colorscheme)|Cette énumération spécifie le jeu de couleurs du graphique.|
||[roundedCorners](/javascript/api/excel/excel.chartareaformat#roundedcorners)|Indique si la zone de graphique du graphique possède des angles arrondis.|
|[ChartAxis](/javascript/api/excel/excel.chartaxis)|[linkNumberFormat](/javascript/api/excel/excel.chartaxis#linknumberformat)|Indique si le format de nombre est lié aux cellules.|
|[ChartBinOptions](/javascript/api/excel/excel.chartbinoptions)|[allowOverflow](/javascript/api/excel/excel.chartbinoptions#allowoverflow)|Indique si le débordement d’emplacement est activé dans un histogramme ou un graphique de Pareto.|
||[allowUnderflow](/javascript/api/excel/excel.chartbinoptions#allowunderflow)|Indique si la débordement d’emplacement est activé dans un histogramme ou un graphique de Pareto.|
||[count](/javascript/api/excel/excel.chartbinoptions#count)|Indique le nombre d’emplacements d’un histogramme ou d’un graphique de Pareto.|
||[overflowValue](/javascript/api/excel/excel.chartbinoptions#overflowvalue)|Indique la valeur de dépassement de l’emplacement d’un histogramme ou d’un graphique de Pareto.|
||[type](/javascript/api/excel/excel.chartbinoptions#type)|Indique le type de l’emplacement pour un histogramme ou un graphique de Pareto.|
||[underflowValue](/javascript/api/excel/excel.chartbinoptions#underflowvalue)|Indique la valeur de la sous-circulation de l’emplacement d’un histogramme ou d’un graphique de Pareto.|
||[width](/javascript/api/excel/excel.chartbinoptions#width)|Indique la valeur de largeur de l’emplacement d’un histogramme ou d’un graphique de Pareto.|
|[ChartBoxwhiskerOptions](/javascript/api/excel/excel.chartboxwhiskeroptions)|[quartileCalculation](/javascript/api/excel/excel.chartboxwhiskeroptions#quartilecalculation)|Indique si le type de calcul quartile d’un graphique en boîte et en moustaches.|
||[showInnerPoints](/javascript/api/excel/excel.chartboxwhiskeroptions#showinnerpoints)|Indique si les points intérieurs sont affichés dans un graphique en boîte et en moustaches.|
||[showMeanLine](/javascript/api/excel/excel.chartboxwhiskeroptions#showmeanline)|Indique si la ligne moyenne est affichée dans un graphique en boîte et en moustaches.|
||[showMeanMarker](/javascript/api/excel/excel.chartboxwhiskeroptions#showmeanmarker)|Indique si le marqueur moyen est affiché dans un graphique en boîte et en moustaches.|
||[showOutlierPoints](/javascript/api/excel/excel.chartboxwhiskeroptions#showoutlierpoints)|Indique si les points aberrants sont affichés dans un graphique en boîte et en moustaches.|
|[ChartDataLabel](/javascript/api/excel/excel.chartdatalabel)|[linkNumberFormat](/javascript/api/excel/excel.chartdatalabel#linknumberformat)|Indique si le format de nombre est lié aux cellules (de sorte que le format de nombre est modifié dans les étiquettes lorsqu’il est modifié dans les cellules).|
|[ChartDataLabels](/javascript/api/excel/excel.chartdatalabels)|[linkNumberFormat](/javascript/api/excel/excel.chartdatalabels#linknumberformat)|Indique si le format de nombre est lié aux cellules.|
|[ChartErrorBars](/javascript/api/excel/excel.charterrorbars)|[endStyleCap](/javascript/api/excel/excel.charterrorbars#endstylecap)|Indique si les barres d’erreur sont dotées d’un embout de style.|
...
||[visible](/javascript/api/excel/excel.charterrorbars#visible)|Indique si les barres d’erreur sont affichées.|
...
|[ChartMapOptions](/javascript/api/excel/excel.chartmapoptions)|[labelStrategy](/javascript/api/excel/excel.chartmapoptions#labelstrategy)|Cette énumération spécifie la stratégie d’étiquettes de cartes d’un graphique de carte de région.|
||[level](/javascript/api/excel/excel.chartmapoptions#level)|Spécifie le niveau de mappage de série d’un graphique de carte de région.|
||[projectionType](/javascript/api/excel/excel.chartmapoptions#projectiontype)|Indique le type de projection de série d’un graphique de carte de région.|
|[ChartPivotOptions](/javascript/api/excel/excel.chartpivotoptions)|[showAxisFieldButtons](/javascript/api/excel/excel.chartpivotoptions#showaxisfieldbuttons)|Indique si les boutons de champ d’axe d’un graphique croisé dynamique doivent être affichés.|
||[showLegendFieldButtons](/javascript/api/excel/excel.chartpivotoptions#showlegendfieldbuttons)|Indique si les boutons de champ de légende doivent être affichés sur un graphique croisé dynamique.|
||[showReportFilterFieldButtons](/javascript/api/excel/excel.chartpivotoptions#showreportfilterfieldbuttons)|Indique si les boutons de champ de filtre de rapport doivent être affichés sur un graphique croisé dynamique.|
||[showValueFieldButtons](/javascript/api/excel/excel.chartpivotoptions#showvaluefieldbuttons)|Spécifie s’il faut afficher les boutons de champ Afficher la valeur sur un graphique croisé dynamique.|
...
||[gradientMaximumColor](/javascript/api/excel/excel.chartseries#gradientmaximumcolor)|Cette énumération spécifie la couleur de la valeur maximale d’une série de graphiques de carte de région.|
||[gradientMaximumType](/javascript/api/excel/excel.chartseries#gradientmaximumtype)|Cette énumération spécifie le type de valeur maximale d’une série de graphiques de carte de région.|
||[gradientMaximumValue](/javascript/api/excel/excel.chartseries#gradientmaximumvalue)|Indique la valeur maximale d’une série de graphiques de carte de région.|
||[gradientMidpointColor](/javascript/api/excel/excel.chartseries#gradientmidpointcolor)|Indique la couleur de la valeur milieu d’une série de graphiques de carte de région.|
||[gradientMidpointType](/javascript/api/excel/excel.chartseries#gradientmidpointtype)|Spécifie le type de la valeur de milieu d’une série de graphiques de carte de région.|
||[gradientMidpointValue](/javascript/api/excel/excel.chartseries#gradientmidpointvalue)|Spécifie la valeur de milieu d’une série de graphiques de carte de région.|
||[gradientMinimumColor](/javascript/api/excel/excel.chartseries#gradientminimumcolor)|Cette énumération spécifie la couleur de la valeur minimale d’une série de graphiques de carte de région.|
||[gradientMinimumType](/javascript/api/excel/excel.chartseries#gradientminimumtype)|Cette énumération spécifie le type de la valeur minimale d’une série de graphiques de carte de région.|
||[gradientMinimumValue](/javascript/api/excel/excel.chartseries#gradientminimumvalue)|Indique la valeur minimale d’une série de graphiques de carte de région.|
||[gradientStyle](/javascript/api/excel/excel.chartseries#gradientstyle)|Cette énumération spécifie le style de dégradé de série d’un graphique de carte de région.|
||[invertColor](/javascript/api/excel/excel.chartseries#invertcolor)|Spécifie la couleur de remplissage pour les points de données négatifs dans une série.|
||[parentLabelStrategy](/javascript/api/excel/excel.chartseries#parentlabelstrategy)|Spécifie la zone de stratégie d’étiquette de série parent pour un graphique de compartimentage.|
...
||[showConnectorLines](/javascript/api/excel/excel.chartseries#showconnectorlines)|Indique si les connecteurs sont affichés dans les graphiques en cascade.|
||[showLeaderLines](/javascript/api/excel/excel.chartseries#showleaderlines)|Indique si les lignes d’étiquettes sont affichées pour chaque étiquette de données de la série.|
||[splitValue](/javascript/api/excel/excel.chartseries#splitvalue)|Spécifie la valeur de seuil qui sépare deux sections d’un graphique en secteurs de secteur ou un graphique en barres de secteur.|
|[ChartTrendlineLabel](/javascript/api/excel/excel.charttrendlinelabel)|[linkNumberFormat](/javascript/api/excel/excel.charttrendlinelabel#linknumberformat)|Indique si le format de nombre est lié aux cellules (de sorte que le format de nombre est modifié dans les étiquettes lorsqu’il est modifié dans les cellules).|
...
|[HeaderFooter](/javascript/api/excel/excel.headerfooter)|[centerFooter](/javascript/api/excel/excel.headerfooter#centerfooter)|Pied de page central de la feuille de calcul.|
||[centerHeader](/javascript/api/excel/excel.headerfooter#centerheader)|En-tête central de la feuille de calcul.|
||[leftFooter](/javascript/api/excel/excel.headerfooter#leftfooter)|Pied de page gauche de la feuille de calcul.|
||[leftHeader](/javascript/api/excel/excel.headerfooter#leftheader)|En-tête gauche de la feuille de calcul.|
||[rightFooter](/javascript/api/excel/excel.headerfooter#rightfooter)|Pied de page droit de la feuille de calcul.|
||[rightHeader](/javascript/api/excel/excel.headerfooter#rightheader)|L’en-tête droit de la feuille de calcul.|
...
||[state](/javascript/api/excel/excel.headerfootergroup#state)|État par lequel les en-têtes/pieds de page sont définis.|
...
||[id](/javascript/api/excel/excel.image#id)|Spécifie l’identificateur de la forme de l’objet image.|
...
||[maxChange](/javascript/api/excel/excel.iterativecalculation#maxchange)|Spécifie l’écart maximal entre chaque itération au fur et à mesure que Excel résout les références circulaires.|
...
||[id](/javascript/api/excel/excel.line#id)|Spécifie l’identificateur de la forme.|
||[isBeginConnected](/javascript/api/excel/excel.line#isbeginconnected)|Indique si le début de la ligne spécifiée est connecté à une forme.|
||[isEndConnected](/javascript/api/excel/excel.line#isendconnected)|Indique si la fin de la ligne spécifiée est connectée à une forme.|
...
||[columnIndex](/javascript/api/excel/excel.pagebreak#columnindex)|Spécifie l’index de la colonne pour le saut de page|
||[rowIndex](/javascript/api/excel/excel.pagebreak#rowindex)|Spécifie l’index de ligne pour le saut de page|
...
||[centerHorizontally](/javascript/api/excel/excel.pagelayout#centerhorizontally)|Indicateur horizontal de la feuille de calcul.|
...
||[firstPageNumber](/javascript/api/excel/excel.pagelayout#firstpagenumber)|Numéro de la première page de la feuille de calcul à imprimer.|
||[footerMargin](/javascript/api/excel/excel.pagelayout#footermargin)|Marge de pied de page de la feuille de calcul, exprimée en points, à utiliser lors de l’impression.|
...
||[headerMargin](/javascript/api/excel/excel.pagelayout#headermargin)|Marge d’en-tête de la feuille de calcul, exprimée en points, à utiliser lors de l’impression.|
||[leftMargin](/javascript/api/excel/excel.pagelayout#leftmargin)|Marge de gauche de la feuille de calcul, exprimée en points, à utiliser lors de l’impression.|
||[Orientation](/javascript/api/excel/excel.pagelayout#orientation)|Orientation de la feuille de calcul.|
||[paperSize](/javascript/api/excel/excel.pagelayout#papersize)|Taille du papier de la feuille de calcul de la page.|
||[printComments](/javascript/api/excel/excel.pagelayout#printcomments)|Indique si les commentaires de la feuille de calcul doivent être affichés lors de l’impression.|
||[printErrors](/javascript/api/excel/excel.pagelayout#printerrors)|Option imprimer les erreurs de la feuille de calcul.|
||[printGridlines](/javascript/api/excel/excel.pagelayout#printgridlines)|Indique si le quadrillage de la feuille de calcul est imprimé.|
||[printHeadings](/javascript/api/excel/excel.pagelayout#printheadings)|Indique si les en-têtes de la feuille de calcul seront imprimés.|
||[printOrder](/javascript/api/excel/excel.pagelayout#printorder)|Option d’impression de page de la feuille de calcul.|
...
||[rightMargin](/javascript/api/excel/excel.pagelayout#rightmargin)|Marge de droite de la feuille de calcul, exprimée en points, à utiliser lors de l’impression.|
...
||[topMargin](/javascript/api/excel/excel.pagelayout#topmargin)|Marge supérieure de la feuille de calcul, exprimée en points, à utiliser lors de l’impression.|
||[zoom](/javascript/api/excel/excel.pagelayout#zoom)|Options de zoom d’impression de la feuille de calcul.|
|[PageLayoutMarginOptions](/javascript/api/excel/excel.pagelayoutmarginoptions)|[bas](/javascript/api/excel/excel.pagelayoutmarginoptions#bottom)|Spécifie la marge inférieure de la mise en page dans l’unité spécifiée à utiliser pour l’impression.|
...
||[header](/javascript/api/excel/excel.pagelayoutmarginoptions#header)|Spécifie la marge d’en-tête de la mise en page dans l’unité spécifiée à utiliser pour l’impression.|
||[left](/javascript/api/excel/excel.pagelayoutmarginoptions#left)|Spécifie la marge de gauche de la mise en page dans l’unité spécifiée à utiliser pour l’impression.|
||[right](/javascript/api/excel/excel.pagelayoutmarginoptions#right)|Spécifie la marge de droite de la mise en page dans l’unité spécifiée à utiliser pour l’impression.|
||[top](/javascript/api/excel/excel.pagelayoutmarginoptions#top)|Spécifie la marge supérieure de la mise en page dans l’unité spécifiée à utiliser pour l’impression.|
...
|[PivotLayout](/javascript/api/excel/excel.pivotlayout)|[autoFormat](/javascript/api/excel/excel.pivotlayout#autoformat)|Indique si la mise en forme est automatiquement mise en forme lorsqu’elle est actualisée ou lorsque les champs sont déplacés.|
...
||[preserveFormatting](/javascript/api/excel/excel.pivotlayout#preserveformatting)|Indique si la mise en forme est conservée lorsque le rapport est actualisé ou recalcule par des opérations telles que le pivotement, le tri ou la modification des éléments de champ de page.|
...
|[PivotTable](/javascript/api/excel/excel.pivottable)|[enableDataValueEditing](/javascript/api/excel/excel.pivottable#enabledatavalueediting)|Indique si le tableau croisé dynamique permet aux valeurs du corps de données d’être modifiées par l’utilisateur.|
||[useCustomSortLists](/javascript/api/excel/excel.pivottable#usecustomsortlists)|Indique si le tableau croisé dynamique utilise des listes personnalisées lors du tri.|
|[Range](/javascript/api/excel/excel.range)|[AutoFill (destinationRange ?: Range \| String, autoFillType ?: Excel. autoFillType)](/javascript/api/excel/excel.range#autofill-destinationrange--autofilltype-)|Remplit la plage de la plage actuelle jusqu’à la plage de destination à l’aide de la logique de remplissage automatique spécifiée.|
...
||[format](/javascript/api/excel/excel.rangeareas#format)|Renvoie un objet RangeFormat, qui encapsule la police, le remplissage, les bordures, l’alignement et d’autres propriétés pour toutes les plages de l’objet RangeAreas.|
||[isEntireColumn](/javascript/api/excel/excel.rangeareas#isentirecolumn)|Indique si toutes les plages de cet objet RangeAreas représentent des colonnes entières (par exemple, « A :C », « Q :Z »).|
||[isEntireRow](/javascript/api/excel/excel.rangeareas#isentirerow)|Indique si toutes les plages de cet objet RangeAreas représentent des lignes entières (par exemple, « 1:3, 5:7 »).|
...
|[RangeBorder](/javascript/api/excel/excel.rangeborder)|[tintAndShade](/javascript/api/excel/excel.rangeborder#tintandshade)|Spécifie un double qui éclaircit ou assombrit une couleur pour une bordure de plage, la valeur est comprise entre-1 (sombre) et 1 (le plus clair), 0 pour la couleur d’origine.|
|[RangeBorderCollection](/javascript/api/excel/excel.rangebordercollection)|[tintAndShade](/javascript/api/excel/excel.rangebordercollection#tintandshade)|Spécifie un double qui éclaircit ou assombrit une couleur pour les bordures de plage, la valeur est comprise entre-1 (le plus foncé) et 1 (le plus clair), avec 0 pour la couleur d’origine.|
...
||[tintAndShade](/javascript/api/excel/excel.rangefont#tintandshade)|Spécifie un double qui éclaircit ou assombrit la couleur de la police de plage, la valeur est comprise entre-1 (le plus foncé) et 1 (le plus clair), avec 0 pour la couleur d’origine.|
|[RangeFormat](/javascript/api/excel/excel.rangeformat)|[autoIndent](/javascript/api/excel/excel.rangeformat#autoindent)|Indique si le texte est automatiquement mis en retrait lorsque l’alignement du texte est défini sur une distribution égale.|
...
||[shrinkToFit](/javascript/api/excel/excel.rangeformat#shrinktofit)|Indique si le texte s’ajuste automatiquement à la largeur de colonne disponible.|
...
|[ReplaceCriteria](/javascript/api/excel/excel.replacecriteria)|[completeMatch](/javascript/api/excel/excel.replacecriteria#completematch)|Indique si la correspondance doit être terminée ou partielle.|
||[matchCase](/javascript/api/excel/excel.replacecriteria#matchcase)|Indique si la correspondance respecte la casse.|
...
|[SearchCriteria](/javascript/api/excel/excel.searchcriteria)|[completeMatch](/javascript/api/excel/excel.searchcriteria#completematch)|Indique si la correspondance doit être terminée ou partielle.|
||[matchCase](/javascript/api/excel/excel.searchcriteria#matchcase)|Indique si la correspondance respecte la casse.|
...
|[Shape](/javascript/api/excel/excel.shape)|[altTextDescription](/javascript/api/excel/excel.shape#alttextdescription)|Cette énumération spécifie le texte de description de remplacement d’un objet Shape.|
||[altTextTitle](/javascript/api/excel/excel.shape#alttexttitle)|Cette énumération spécifie le texte de l’autre titre de l’objet Shape.|
||[delete()](/javascript/api/excel/excel.shape#delete--)|Supprime la forme à partir de la feuille de calcul.|
||[geometricShapeType](/javascript/api/excel/excel.shape#geometricshapetype)|Indique le type de forme géométrique de cette forme géométrique.|
...
||[height](/javascript/api/excel/excel.shape#height)|Indique la hauteur, exprimée en points, de la forme.|
...
||[lockAspectRatio](/javascript/api/excel/excel.shape#lockaspectratio)|Indique si les proportions de cette forme sont verrouillées.|
||[name](/javascript/api/excel/excel.shape#name)|Cette énumération spécifie le nom de la forme.|
...
||[id](/javascript/api/excel/excel.shape#id)|Spécifie l’identificateur de la forme.|
||[image](/javascript/api/excel/excel.shape#image)|Renvoie l’image associé à la forme.|
||[level](/javascript/api/excel/excel.shape#level)|Cette énumération spécifie le niveau de la forme spécifiée.|
...
||[visible](/javascript/api/excel/excel.shape#visible)|Indique si la forme est visible.|
||[width](/javascript/api/excel/excel.shape#width)|Indique la largeur, exprimée en points, de la forme.|
...
||[foregroundColor](/javascript/api/excel/excel.shapefill#foregroundcolor)|Représente la couleur de remplissage de remplissage de forme au format HTML, de la #RRGGBB de formulaire (par exemple, « FFA500 ») ou sous forme de couleur HTML nommée (par exemple, « orange »).|
...
||[Transparency](/javascript/api/excel/excel.shapefill#transparency)|Spécifie le pourcentage de transparence du remplissage sous la forme d’une valeur comprise entre 0,0 (opaque) et 1,0 (clair).|
...
||[color](/javascript/api/excel/excel.shapefont#color)|Représentation de code de couleur HTML de la couleur du texte (par exemple, « #FF0000 » représente le rouge).|
...
||[size](/javascript/api/excel/excel.shapefont#size)|Représente la taille de la police en points (par exemple, 11).|
||[underline](/javascript/api/excel/excel.shapefont#underline)|Type de soulignement appliqué à la police.|
|[ShapeGroup](/javascript/api/excel/excel.shapegroup)|[id](/javascript/api/excel/excel.shapegroup#id)|Spécifie l’identificateur de la forme.|
...
|[ShapeLineFormat](/javascript/api/excel/excel.shapelineformat)|[color](/javascript/api/excel/excel.shapelineformat#color)|Représente la couleur de trait au format de couleur HTML, sous la forme #RRGGBB (par exemple, « FFA500 ») ou sous forme de couleur HTML nommée (par exemple, « orange »).|
...
||[visible](/javascript/api/excel/excel.shapelineformat#visible)|Indique si la mise en forme de trait d’un élément Shape est visible.|
||[weight](/javascript/api/excel/excel.shapelineformat#weight)|Représente l’épaisseur de ligne, en points.|
|[SortField](/javascript/api/excel/excel.sortfield)|[subField](/javascript/api/excel/excel.sortfield#subfield)|Spécifie le sous-champ qui est le nom de la propriété cible d’une valeur enrichie à trier.|
...
|[TableChangedEventArgs](/javascript/api/excel/excel.tablechangedeventargs)|[Détails](/javascript/api/excel/excel.tablechangedeventargs#details)|Obtient les informations sur les détails des modifications.|
...
||[worksheetId](/javascript/api/excel/excel.tabledeletedeventargs#worksheetid)|Obtient l’ID de la feuille de calcul dans laquelle la table est supprimée.|
...
|[TextFrame](/javascript/api/excel/excel.textframe)|[autoSizeSetting](/javascript/api/excel/excel.textframe#autosizesetting)|Les paramètres de dimensionnement automatique pour le cadre de texte.|
...
||[Orientation](/javascript/api/excel/excel.textframe#orientation)|Représente l’angle auquel le texte est orienté pour le cadre de texte.|
...
||[hasText](/javascript/api/excel/excel.textframe#hastext)|Indique si le cadre de texte contient du texte.|
...
||[isDirty](/javascript/api/excel/excel.workbook#isdirty)|Indique si des modifications ont été apportées depuis le dernier enregistrement du classeur.|
||[autoSave](/javascript/api/excel/excel.workbook#autosave)|Indique si le classeur est en mode d’enregistrement automatique.|
...
||[previouslySaved](/javascript/api/excel/excel.workbook#previouslysaved)|Indique si le classeur a déjà été enregistré en local ou en ligne.|
...
|[Worksheet](/javascript/api/excel/excel.worksheet)|[enableCalculation](/javascript/api/excel/excel.worksheet#enablecalculation)|Détermine si Excel doit recalculer la feuille de calcul lorsque cela est nécessaire.|
...
|[worksheetChangedEventArgs](/javascript/api/excel/excel.worksheetchangedeventargs)|[détails](/javascript/api/excel/excel.worksheetchangedeventargs#details)|Représente les informations sur les détails des modifications.|
...
|[WorksheetSearchCriteria](/javascript/api/excel/excel.worksheetsearchcriteria)|[completeMatch](/javascript/api/excel/excel.worksheetsearchcriteria#completematch)|Indique si la correspondance doit être terminée ou partielle.|
||[matchCase](/javascript/api/excel/excel.worksheetsearchcriteria#matchcase)|Indique si la correspondance respecte la casse.|
